...
def main():
    ...
    # Analyze all indices vs. housing from 1992-2021
    util.generate_ts_plot(nndf, SPCS_BUBBLE_BEGIN, SPCS_BUBBLE_END, 
                          "Normalized Values",
                          "Stock Market Indicies and the Housing Bubble "\
    ...
    util.generate_ts_plot(pre_bubble_df, None, None, 
                          "Normalized Values",
    ...
    util.generate_ts_plot(bubble_df, None, None, 
                          "Normalized Values",
    ...
    util.generate_ts_plot(post_bubble_df, None, None, 
                          "Normalized Values",
    ...
    util.generate_norm_scatterplot(ndf, "IXIC_ADJCLOSE", "SPCS10RSA", \
                              'Nasdaq Close', \
    ...
    util.generate_norm_scatterplot(ndf, "GSPC_ADJCLOSE", "SPCS10RSA", \
                              'S&P500 Close', \
                              'Case Shiller 10 City Composite (Index)', \
    ...
    util.generate_norm_scatterplot(ndf, "DJI_ADJCLOSE", "SPCS10RSA", \
                              'DJII Close', \
                              'Case Shiller 10 City Composite (Index)', \
